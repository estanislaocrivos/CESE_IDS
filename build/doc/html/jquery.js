...
!function(t) {
  ...
  y.widget =
    ...
    return e || (e = i, i = y.Widget),
           ...
           y.expr.pseudos[r.toLowerCase()] = function(
               t) { return !!y.data(t, r) },
           y[a] = y[a] || {}, s = y[a][t],
           n = y[a][t] =
               function(t, e) {
  ...
  y.widget.bridge =
    ...
    y.fn[o] = function(i) {
      ...
      return t ? this.length || "instance" !== i ? this.each(function() {
        ...
        return "instance" === i ? (n = e, !1)
               : e ? "function" != typeof e[i] || "_" === i.charAt(0)
                         ? y.error("no such method '" + i + "' for " + o +
                                   " widget instance")
  ...
  y.Widget.prototype = {
    ...
    _createWidget : function(t, e) {
      ...
      e !== this &&
          (y.data(e, this.widgetFullName, this), this._on(!0, this.element, {
            remove : function(t) { t.target === e && this.destroy() }
          }),
    ...
    destroy : function() {
      var i = this;
      this._destroy(),
          y.each(this.classesElementLookup,
                 function(t, e) { i._removeClass(e, t) }),
          ...
          i = n.add ? (
                          function() {
                            ...
                            n.element.each(function(t, e) {
                              y.map(h.classesElementLookup,
                                    function(t) { return t })
                                      .some(function(t) { return t.is(e) }) ||
                                  i.push(e)
                            }),
    ...
    _hoverable : function(t) {
      this.hoverable = this.hoverable.add(t), this._on(t, {
        mouseenter : function(
            t) { this._addClass(y(t.currentTarget), null, "ui-state-hover") },
        mouseleave : function(
            t) { this._removeClass(y(t.currentTarget), null, "ui-state-hover") }
      })
    },
    _focusable : function(t) {
      this.focusable = this.focusable.add(t), this._on(t, {
        focusin : function(
            t) { this._addClass(y(t.currentTarget), null, "ui-state-focus") },
        focusout : function(
            t) { this._removeClass(y(t.currentTarget), null, "ui-state-focus") }
      })
    },
  ...
  y.each({show : "fadeIn", hide : "fadeOut"}, function(o, h) {
    y.Widget.prototype["_" + o] = function(e, t, i) {
      var s, n = (t = "string" == typeof t ? {effect : t} : t)
      ...
      "number" == typeof (t = t || {})
          ...
          : !0 === t && (t = {}),
            ...
            : n !== o && e[n]
                ...
                : e.queue(function(t) { y(this)[o](), i && i.call(e[0]), t() })
    }
  });
  ...
  function H(t, e) { return parseInt(y.css(t, e), 10) || 0 }
  ...
  y.fn.position = function(p) {
    ...
    var d, c, f, g, m, t,
        _ = "string" == typeof (p = y.extend({}, p)).of ? y(document).find(p.of)
                                                        : y(p.of),
      ...
      left : function(t, e) {
        ...
        a < 0 ? ((s = t.left + l + i + h + e.collisionWidth - n - s) < 0 ||
                 s < D(a)) &&
                    (t.left += l + i + h)
              : 0 < r &&
                    (0 < (o = t.left - e.collisionPosition.marginLeft + l + i +
                              h - o) ||
                     D(o) < r) &&
                    (t.left += l + i + h)
      },
      top : function(t, e) {
        ...
        a < 0 ? ((s = t.top + l + i + h + e.collisionHeight - n - s) < 0 ||
                 s < D(a)) &&
                    (t.top += l + i + h)
              : 0 < r &&
                    (0 < (o = t.top - e.collisionPosition.marginTop + l + i +
                              h - o) ||
                     D(o) < r) &&
                    (t.top += l + i + h)
      }
  ...
  y.ui.position, y.extend(y.expr.pseudos, {
    data : y.expr.createPseudo
               ? y.expr.createPseudo(function(
                     e) { return function(t) { return !!y.data(t, e) } })
               : function(t, e, i) { return !!y.data(t, i[3]) }
  }),
      y.fn.extend({
        disableSelection : (t = "onselectstart" in document.createElement("div")
                                    ? "selectstart"
                                    : "mousedown",
                            function() {
  ...
  y.ui.focusable = function(t, e) {
    ...
    focusable : function(
        t) { return y.ui.focusable(t, null != y.attr(t, "tabindex")) }
  });
  var e, d;
  y.ui.focusable, y.fn._form = function() {
    ...
    _formResetHandler : function() {
      ...
      setTimeout(function() {
        ...
        y.each(t, function() { this.refresh() })
      })
    },
  ...
  y.expr.pseudos || (y.expr.pseudos = y.expr[":"]),
      ...
      y.escapeSelector ||
          (e = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,
           ...
           y.escapeSelector = function(t) { return (t + "").replace(e, d) }),
      y.fn.even && y.fn.odd || y.fn.extend({
        even : function() {
          return this.filter(function(t) { return t % 2 == 0 })
        },
        odd :
            function() { return this.filter(function(t) { return t % 2 == 1 }) }
      });
  y.ui.keyCode = {
    BACKSPACE : 8,
    COMMA : 188,
        ...
        t = this.parents()
                .filter(function() {
                  ...
                  return (!i || "static" !== t.css("position")) &&
                         s.test(t.css("overflow") + t.css("overflow-y") +
                                t.css("overflow-x"))
                })
                .eq(0);
  ...
  y.fn.extend({
    uniqueId : (
        c = 0,
        function() {
          return this.each(function() { this.id || (this.id = "ui-id-" + ++c) })
        }),
  ...
  var c, f = !1;
  y(document).on("mouseup", function() { f = !1 });
  y.widget("ui.mouse", {
    version : "1.13.2",
    options : {
                   ...
                   ? (this.mouseDelayMet = !this.options.delay,
                      this.mouseDelayMet ||
                          (this._mouseDelayTimer =
                               setTimeout(function() { e.mouseDelayMet = !0 },
                                          this.options.delay)),
                      this._mouseDistanceMet(t) && this._mouseDelayMet(t) &&
                          ...
                          : (!0 === y.data(t.target,
                                           this.widgetName +
                                               ".preventClickEvent") &&
                                 y.removeData(t.target,
                                              this.widgetName +
                                                  ".preventClickEvent"),
                             this._mouseMoveDelegate = function(
                                 t) { return e._mouseMove(t) },
                             this._mouseUpDelegate = function(
                                 t) { return e._mouseUp(t) },
                             this.document
  ...
  y.widget("ui.resizable", y.ui.mouse, {
    ...
    _change : {
      ...
      se : function(t, e, i) {
        return y.extend(this._change.s.apply(this, arguments),
      ...
      ne : function(t, e, i) {
        return y.extend(this._change.n.apply(this, arguments),
                        this._change.e.apply(this, [ t, e, i ]))
      },
      nw : function(t, e, i) {
        return y.extend(this._change.n.apply(this, arguments),
    ...
    ui : function() {
               ...
               /document/.test(o) || o === document
                   ...
                   : (i = y(h), s = [],
                      y([ "Top", "Right", "Left", "Bottom" ])
                          .each(function(
                              t, e) { s[t] = n._num(i.css("padding" + e)) }),
        ...
        resize : function(t) {
          ...
          a[0] !== document && /static/.test(a.css("position")) && (h = s),
              n.left < (e._helper ? s.left : 0) &&
                  (e.size.width =
                       e.size.width + (e._helper ? e.position.left - s.left
              ...
              n = Math.abs(e.sizeDiff.width + (e._helper
                                                   ? e.offset.left - h.left
                                                   : e.offset.left - s.left)),
              s = Math.abs(e.sizeDiff.height + (e._helper
                                                    ? e.offset.top - h.top
                                                    : e.offset.top - s.top)),
      ...
      y.ui.plugin.add("resizable", "alsoResize", {
        ...
        stop : function() { y(this).removeData("ui-resizable-alsoresize") }
      }),
      ...
      y.ui.plugin.add("resizable", "grid", {
        resize : function() {
          ...
          g && (c -= l),
          /^(se|s|e)$/.test(h) ? (e.size.width = d, e.size.height = c)
          : /^(ne)$/.test(h)   ? (e.size.width = d, e.size.height = c,
  ...
  if (!options.manual) {
    $.each(options.openEvents, function(idx, evt) {
      if ($.inArray(evt, options.closeEvents) > -1) {
        targetElements.on(
            evt + EVENT_NAMESPACE,
            function elementToggle(event) { $.powerTip.toggle(this, event) })
      } else {
        targetElements.on(
            evt + EVENT_NAMESPACE,
            function elementOpen(event) { $.powerTip.show(this, event) })
      }
    });
      ...
      if ($.inArray(evt, options.openEvents) < 0) {
        targetElements.on(
            ...
            function elementClose(
                event) { $.powerTip.hide(this, !isMouseEvent(event)) })
      }
    });
    targetElements.on("keydown" + EVENT_NAMESPACE,
...
function PlacementCalculator() {
  ...
  function getSvgPlacement(element, placement) {
    var svgElement = element.closest("svg")[0], domElement = element[0],
        ...
        rotation, steps, x;
    function pushPlacement() { placements.push(point.matrixTransform(matrix)) }
...
function TooltipController(options) {
  ...
  function positionTipOnElement(element) {
    ...
    if (options.smartPlacement ||
      ...
      $.each(priorityList, function(idx, pos) {
        var collisions = getViewportCollisions(placeTooltip(element, pos),
  ...
  function placeTooltip(element, placement) {
    ...
    do {
      tipWidth = tipElement.outerWidth();
      tipHeight = tipElement.outerHeight();
      coords = placementCalculator.compute(element, placement, tipWidth,
                                           tipHeight, options.offset);
      tipElement.css(coords)
    } while (++iterationCount <= 5 && (tipWidth !== tipElement.outerWidth() ||
                                       tipHeight !== tipElement.outerHeight()));
    return coords
  }
  function closeDesyncedTip() {
    var isDesynced = false,
        hasDesyncableCloseEvent =
            $.grep([ "mouseleave", "mouseout", "blur", "focusout" ],
                   function(eventType) {
    ...
    if (session.isTipOpen && !session.isClosing && !session.delayInProgress &&
      ...
      if (session.activeHover.data(DATA_HASACTIVEHOVER) === false ||
        ...
        isDesynced = true
      } else if (!isMouseOver(session.activeHover) &&
...
function initMouseDetection(t) {
  ...
  if (mouseDetectionEnabled || t)
    ...
    o[touchEvents
        ...
        function(t) { isTouchEvent(t.originalEvent) && (mouse = !1) },
...
return $.SmartMenus =
  ...
  this.showTimeout = 0, this.hideTimeout = 0, this.scrollTimeout = 0,
  this.clickActivated = !1, this.focusActivated = !1, this.zIndexInc = 0,
  this.idInc = 0, this.$firstLink = null, this.$firstSub = null,
  this.disabled = !1, this.$disableOverlay = null,
  ...
  this.wasCollapsible = !1, this.init()
       ...
       $.extend($.SmartMenus, {
         hideAll : function() {
           $.each(menuTrees, function() { this.menuHideAll() })
         },
         destroy : function() {
         ...
         prototype : {
           ...
           destroy : function(t) {
             ...
             this.$root.find("ul")
                 ...
                 t || (this.$root = null, this.$firstLink = null,
                       this.$firstSub = null,
           ...
           docTouchEnd : function() {
             if (this.lastTouch) {
               if (!(!this.visibleSubMenus.length ||
                 ...
                 var t = this;
                 this.hideTimeout =
                     setTimeout(function() { t.menuHideAll() }, 350)
               }
               this.lastTouch = null
             }
           },
           ...
           handleEvents :
               function() { return !this.disabled && this.isCSSOn() },
           handleItemEvents : function(
               t) { return this.handleEvents() && !this.isLinkInMegaMenu(t) },
           isCollapsible :
               function() { return "static" == this.$firstSub.css("position") },
           isCSSOn :
               function() { return "inline" != this.$firstLink.css("display") },
           isFixed : function() {
           ...
           isLinkInMegaMenu : function(
               t) { return $(this.getClosestMenu(t[0])).hasClass("mega-menu") },
           ...
           itemClick : function(t) {
             ...
             if (this.handleItemEvents(e)) {
               ...
               return this.opts.showOnClick && o || e.hasClass("disabled") ||
                              this.$root.triggerHandler("select.smapi",
                                                        e[0]) === !1
                          ? !1
                          : void 0
             }
           ...
           itemEnter : function(t) {
             ...
             if (this.handleItemEvents(e)) {
               if (!this.isTouchMode()) {
                 ...
                 var i = this;
                 this.showTimeout =
                     setTimeout(function() { i.itemActivate(e) },
           ...
           menuPosition : function(t) {
             var e, i,
                 ...
                 n = t.dataSM("level"), r = this.getWidth(t),
                 ...
                 if (t.dataSM("scroll", {
                        ...
                        arrowDownH :
                         ...
                         .css({
                           ...
                           width :
                               r - (parseInt(t.css("border-left-width")) || 0) -
                   ...
                   C[touchEvents
                       ...
                       function(e) { x.menuScrollTouch(t, e) },
                           t.css({
                              "touch-action" : "none",
           ...
           menuScroll : function(t, e, i) {
             ...
             if (this.activatedItems[r - 1] &&
               ...
               var h = this;
               this.scrollTimeout =
                   requestAnimationFrame(function() { h.menuScroll(t) })
             }
           },
           ...
           menuScrollRefreshData : function(t) {
             var e = t.dataSM("scroll"), i = $(window).scrollTop() -
           ...
           popupHide : function(t) {
             this.hideTimeout &&
                 (clearTimeout(this.hideTimeout), this.hideTimeout = 0);
             var e = this;
             this.hideTimeout = setTimeout(function() { e.menuHideAll() },
           ...
           popupShow : function(t, e) {
             ...
             if (this.hideTimeout &&
               ...
               var i = this, s = function() { i.$root.css("overflow", "") };
               canAnimate && this.opts.showFunction
       ...
       $.fn.removeDataSM = function(
           t) { return this.removeData(t + "_smartmenus") },
       $.fn.smartmenus =
           function(options) {
         ...
         return this.each(function() {
           ...
           new $.SmartMenus(
               this, $.extend({}, $.fn.smartmenus.defaults, options, dataOpts))
         })
       },
       $.fn.smartmenus.defaults = {
         ...
         showFunction : null,
         hideDuration : 0,
         hideFunction : function(t, e) { t.fadeOut(200, e) },
         collapsibleShowDuration : 0,
         collapsibleShowFunction : function(t, e) { t.slideDown(200, e) },
         collapsibleHideDuration : 0,
         collapsibleHideFunction : function(t, e) { t.slideUp(200, e) },
         showOnClick : !1,
         hideOnClick : !0,
         noMouseOver : !1,
         keepInViewport : !0,
